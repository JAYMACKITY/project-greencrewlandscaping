...
function Navbar() {
  ...
  return <header className="navbar">
    <a href="#top" className="brand" onClick={() => setOpen(false)}><span className="brand-mark"><Leaf size={17} /></span><span>Green Crew<span className="brand-sub">Landscaping</span></span></a>
...
function Hero() {
  return <section className="hero section-pad" id="top">
    ...
    <motion.div className="hero-image-wrap" initial={{ opacity: 0, scale: 1.04 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 1, ease: 'easeOut' }}>
      <img src="https://images.unsplash.com/photo-1558904541-efa843a96f01?auto=format&fit=crop&w=1400&q=85" alt="Freshly mowed green lawn beside a garden bed" />
...
function About() {
  return <section className="about section-pad" id="about"><div className="about-copy"><SectionLabel>A little about us</SectionLabel><h2>Built by local teens. <em>Built on hard work.</em></h2><p>Green Crew Landscaping was started by a group of motivated local teens who wanted to build something of their own while helping people in their community.</p><p>We believe good service is pretty simple: show up, communicate clearly, do the work properly, and treat people’s homes with respect.</p><Button href="#contact" secondary>Meet us at your yard</Button></div><div className="about-image"><img src="https://images.unsplash.com/photo-1599685315640-4f1e9ef3a6b0?auto=format&fit=crop&w=1000&q=85" alt="Gardening tools and fresh cuttings on a lawn" /><div className="about-stamp">LOCAL<br /><span>×</span><br />EDMONTON</div></div></section>;
}
